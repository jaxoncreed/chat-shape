...
export type BaseTraverserTypes<TypeNames extends KeyTypes> = InterfaceType<TypeNames> | UnionType<TypeNames> | PrimitiveType;
export type TraverserTypes<TypeNames extends KeyTypes> = {
    [Property in TypeNames]: BaseTraverserTypes<TypeNames>;
};
export type ValidateTraverserTypes<Types extends TraverserTypes<any>> = AssertExtends<TraverserTypes<keyof Types>, Types>;
