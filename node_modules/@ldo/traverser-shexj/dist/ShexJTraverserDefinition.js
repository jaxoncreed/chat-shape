...
exports.ShexJTraverserDefinition = void 0;
exports.ShexJTraverserDefinition = {
    Schema: {
        kind: "interface",
        properties: {
            startActs: "SemAct",
    ...
    shapeExprOrRef: {
        kind: "union",
        selector: (item) => typeof item === "string" || item.type === "ShapeDecl"
            ? "shapeDeclRef"
            : "shapeExpr",
    },
    ShapeOr: {
    ...
    shapeDeclRef: {
        kind: "union",
        selector: (value) => typeof value === "string" ? "shapeDeclLabel" : "ShapeDecl",
    },
    shapeDeclLabel: {
        kind: "union",
        selector: () => "IRIREF",
    ...
    objectValue: {
        kind: "union",
        selector: (item) => typeof item === "string" ? "IRIREF" : "ObjectLiteral",
    },
    ObjectLiteral: {
        kind: "interface",
        properties: {
    ...
    LanguageStemRangeExclusions: {
        kind: "union",
        selector: (item) => typeof item === "string" ? "LANGTAG" : "LanguageStem",
    },
    Wildcard: {
        kind: "interface",
        properties: {},
    ...
    tripleExprOrRef: {
        kind: "union",
        selector: (item) => typeof item === "string" ? "tripleExprRef" : "tripleExpr",
    },
    EachOf: {
        kind: "interface",
        properties: {
...
//# sourceMappingURL=ShexJTraverserDefinition.js.map