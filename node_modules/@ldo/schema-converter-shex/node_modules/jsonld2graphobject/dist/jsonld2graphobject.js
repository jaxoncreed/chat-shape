...
exports.jsonld2graphobject = void 0;
 ...
 */
function setTripleArcs(tripleArcs, subjectId, predicateId, objectId, isArray) {
 ...
 *
 */
function getObjectId(object, scopedContext) {
    if (object["@id"]) {
        return object["@id"];
    }
    else if (scopedContext) {
        var mappedIdEntry = Object.entries(scopedContext).find(function (_a) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    _a.label = 4;
                case 4:
                    objectId = getObjectId(object, scopedContext);
                    if (!idMap[objectId]) {
                        idMap[objectId] = [];
                    }
                    ...
                    return [4 /*yield*/, Promise.all(Object.entries(object).map(function (_a) {
                            ...
                            return __awaiter(_this, void 0, void 0, function () {
                                var graph, valueId, setTripleArcsParams;
                                var _this = this;
                                return __generator(this, function (_c) {
                                    switch (_c.label) {
                                            ...
                                            return [4 /*yield*/, Promise.all(value.map(function (arrValue) { return __awaiter(_this, void 0, void 0, function () {
                                                    ...
                                                    return __generator(this, function (_a) {
                                                        switch (_a.label) {
                                                            ...
                                                            case 1:
                                                                valueId = _a.sent();
                                                                return [2 /*return*/, [tripleArcs, objectId, key, valueId, true]];
                                                            case 2:
                                                                if (typeof arrValue === "string" &&
                                                                    idPredicates.has(key)) {
                                                                    return [2 /*return*/, [tripleArcs, objectId, key, arrValue, true]];
                                                                }
                                                                _a.label = 3;
                                        ...
                                        case 5:
                                            setTripleArcsParams = (_c.sent()).filter(function (value) {
                                                return value !== undefined;
                                            });
                                            setTripleArcsParams.forEach(function (params) {
                                                setTripleArcs.apply(void 0, __spreadArray([], __read(params), false));
                                            });
                                            return [3 /*break*/, 7];
                                        case 6:
 ...
 */
function jsonld2graphobject(jsonLd, node, options) {
    return __awaiter(this, void 0, void 0, function () {
                                ...
                                return __generator(this, function (_e) {
                                    switch (_e.label) {
                                        ...
                                        case 2:
                                            ...
                                            if (options === null || options === void 0 ? void 0 : options.excludeContext) {
...
exports.jsonld2graphobject = jsonld2graphobject;
